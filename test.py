...
def ask_question(query, image_path, base_url="http://127.0.0.1:5005"):
    """
    ...
    try:
        response = requests.get(url, params={"query": query, "image_path": image_path})
...
if __name__ == "__main__":
    ...
    # --- Test /ask endpoint ---
    questions = [
        ["I am at Server Room 1, what should I do?", 'im2.png'],
        ["I did that, what should I do next?", 'im4.png'],
        ["ohh, my mistake. ok what should I do now?", 'im6.png'],
    ...
    for question in questions:
        response = ask_question(question[0], image_path=question[1])
        if response:
